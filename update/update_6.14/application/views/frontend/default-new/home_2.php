...
<section class="courses grid-view-body pt-50 pb-4  wow  animate__animated animate__fadeInUp opacityOnUp" data-wow-duration="1000" data-wow-delay="500">
    <div class="container">
...
<section class="courses Ecourse grid-view-body pb-4  wow  animate__animated animate__fadeInUp opacityOnUp" data-wow-duration="1000" data-wow-delay="500">
    <div class="container">
...
<section class="expert-instructor top-categories pb-3  wow  animate__animated animate__fadeInUp opacityOnUp" data-wow-duration="1000" data-wow-delay="500">
  <div class="container">
    <div class="row">
      <div class="col-lg-3"></div>
      <div class="col-lg-6">
...
<section class="courses blog  wow  animate__animated animate__fadeInUp opacityOnUp" data-wow-duration="1000" data-wow-delay="500">
    <div class="container">
        <h1 class="text-center"><span>أحدث المقالات</span></h1>
        <p class="text-center">قم بزيارة مقالاتنا القيمة للحصول على المزيد من المعلومات
        <div class="courses-card mt-4">
            <div class="row">
...
<section class="student eStudent estudent2  wow  animate__animated animate__fadeInUp opacityOnUp" data-wow-duration="1000" data-wow-delay="500">
    <div class="container">
        <div class="row">
