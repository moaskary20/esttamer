                                    ...
                                    <div class="icon-div-2">
                                        <?php if($social_links['facebook']): ?>
                                            ...
                                            <svg width="18" height="16" viewBox="0 0 18 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <rect width="16.8019" height="16" fill="white" transform="translate(0.65918)"/>
                                                </clipPath>
                                                </defs>
                                                </svg>
                                        ...
                                        <?php  if($social_links['twitter']): ?>
                                            ...
                                            <svg width="18" height="16" viewBox="0 0 18 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <defs>
                                                <clipPath id="clip0_17_3533">
                                                <rect width="17.0072" height="16" fill="white" transform="translate(0.460938)"/>
                                                </clipPath>
                                                </defs>
                                                </svg>
                                        ...
                                        <?php  if($social_links['linkedin']): ?>
                                            ...
                                            <svg width="18" height="16" viewBox="0 0 18 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <defs>
                                                <clipPath id="clip0_17_3536">
                                                <rect width="16.8019" height="16" fill="white" transform="translate(0.540039)"/>
                                                </clipPath>
                                                </defs>
                                                </svg>
