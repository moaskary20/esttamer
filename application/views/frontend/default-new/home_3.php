...
<section class="pt-100 pb-50 wow animate__animated  animate__fadeInUp " data-wow-duration="1000" data-wow-delay="500">
  <div class="container">
    <div class="row">
      <div class="col-lg-4">
...
<section class="courses grid-view-body pt-50 pb-4 wow animate__animated  animate__fadeInUp " data-wow-duration="1000" data-wow-delay="500">
    <div class="container">
        <h1 class="text-center"><span><?php echo site_phrase('top_courses'); ?></span></h1>
...
<section class="courses Ecourse grid-view-body pb-4 wow animate__animated  animate__fadeInUp " data-wow-duration="1000" data-wow-delay="500">
    <div class="container">
...
<section class="expert-instructor top-categories pb-3 wow animate__animated  animate__fadeInUp " data-wow-duration="1000" data-wow-delay="500">
  <div class="container">
    <div class="row">
      <div class="col-lg-3"></div>
      <div class="col-lg-6">
        <h1 class="text-center mt-4"><?php echo get_phrase('Think more clearly'); ?></h1>
        <p class="text-center mt-4 mb-5"><?php echo get_phrase('Gather your thoughts, and make your decisions clearly') ?></p>
      </div>
      <div class="col-lg-3"></div>
    </div>
...
<section class="h-2-courses h-3-courses wow animate__animated  animate__fadeInUp " data-wow-duration="1000" data-wow-delay="500">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-6">
                <h1 class="mt-5  efont"><?php echo get_phrase('Latest from our blog'); ?></h1>
                <p class="mt-2"><?php echo site_phrase('Visit our valuable articles to get more information.')?></p>
            </div>
            <div class="col-lg-6">
...
<section class="faq wow animate__animated  animate__fadeInUp " data-wow-duration="1000" data-wow-delay="500">
    <div class="container">
        <div class="row">
            <div class="col-lg-2"></div>
            <div class="col-lg-8">
                <h1 class="text-center mt-4 efont"><?php echo get_phrase('Frequently Asked Questions') ?></h1>
