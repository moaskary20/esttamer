	                ...
	                <div class="card  eGridCourse epopCourse courses-card-body position-relative">
	                    <div class="courses-card-image">
						 ...
						 <div class="courses-text">
								<a href="<?php echo site_url('home/course/' . slugify($course_1_details['title']) . '/' . $course_1_details['id']) ?>"><h3><?php echo $course_1_details['title']; ?></h3></a>
                ...
                <?php if(isset($course_2_details['title'])): ?>
	                <div class="card  eGridCourse epopCourse courses-card-body position-relative">
						...
						<div class="courses-card-image">
					    	...
					    	<div class="courses-text">
								<a href="<?php echo site_url('home/course/' . slugify($course_2_details['title']) . '/' . $course_2_details['id']) ?>"><h3><?php echo $course_2_details['title']; ?></h3></a>
                ...
                <?php if(isset($course_3_details['title'])): ?>
	                <div class="card  eGridCourse epopCourse courses-card-body position-relative">
	                   <div class="courses-card-image">
						...
						<div class="courses-text">
							<a href="<?php echo site_url('home/course/' . slugify($course_3_details['title']) . '/' . $course_3_details['id']) ?>"><h3><?php echo $course_3_details['title']; ?></h3></a>
