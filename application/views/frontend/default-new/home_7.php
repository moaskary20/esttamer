    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6">
                ...
                <p class="text-center mb-5"><?php echo get_phrase('إنهم يخدمون عددًا كبيرًا من الطلاب على منصتنا بكفاءة') ?></p>
            </div>
            <div class="col-lg-3 "></div>
        </div>
...
<section class="faq py-5 wow  animate__animated animate__fadeInUp opacityOnUp" data-wow-duration="1000" data-wow-delay="500">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-8">
                <h1 class="text-center mb-2"><?php echo get_phrase('الأسئلة المتكررةs') ?></h1>
