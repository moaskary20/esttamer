...
<section class="blog-body courses blog pb-3 mb-5">
    <div class="container">
        <h1 class="text-center mb-2"><span><?php echo get_phrase('Inspirational Journeys'); ?></span></h1>
        <p class="text-center mb-4"><?php echo get_phrase('Follow the Stories of Academics and Their Research Expeditions') ?></p>
