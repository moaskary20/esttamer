    ...
    <div class="offcanves-top">
      <?php if($user_id > 0): ?>
        <div class="offcanves-profile">
          <a href="#">
            <div class="user-img">
               <img loading="lazy" src="<?php echo $this->user_model->get_user_image_url($user_id); ?>" alt="img" />
            </div>
    ...
    <div class="offcanvas-body p-0">
      <div class="flex-shrink-0 mt-3">
        <ul class="list-unstyled ps-0">
          ...
          <li>
            <a href="<?php echo site_url('home/shopping_cart'); ?>" 
              ...
              <?php echo site_phrase('Cart'); ?> 
              <span class="badge bg-danger ms-auto"><?php echo count($cart_items); ?></span>
            </a>
          </li>
