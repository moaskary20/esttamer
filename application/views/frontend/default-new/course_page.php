                ...
                <div class="course-left-side">
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            ...
                            <span class="ms-1"><?php echo get_phrase('الدروس') ?></span></button>
                        </li>
                        <li class="nav-item" role="presentation">
                        ...
                        <li class="nav-item" role="presentation">
                            ...
                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <span class="ms-1"><?php echo get_phrase('التقييمات') ?></span></button>
                        </li>
                    </ul>
...
<section class="courses grid-view-body course-details-card mt-5">
    <div class="container">
        <h1><?php echo get_phrase('الدورات ذات الصلة'); ?></h1>
